package com.julius.weatherapp.data.repositories

import com.julius.weatherapp.data.local.WeatherDatabase
import com.julius.weatherapp.data.model.WeatherDataResponse
import com.julius.weatherapp.data.model.WeatherDetail
import com.julius.weatherapp.data.network.ApiInterface
import com.julius.weatherapp.data.network.SafeApiRequest
